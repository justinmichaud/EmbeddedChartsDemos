#!/usr/bin/env node
// Benchmark launcher for JSChartsNoLeaks. Override defaults with flags, e.g.:
//   node bench-JSChartsNoLeaks.mjs --duration 30 --recover 15 [--interval 1000]
...
const def = { ...WEB_APPS.JSChartsNoLeaks };
