#!/usr/bin/env node
// Benchmark launcher for WasmCharts. Override defaults with flags, e.g.:
//   node bench-WasmCharts.mjs --duration 30 --recover 15 [--interval 1000]
