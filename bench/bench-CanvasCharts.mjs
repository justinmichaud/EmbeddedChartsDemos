#!/usr/bin/env node
// Benchmark launcher for CanvasCharts. Override defaults with flags, e.g.:
//   node bench-CanvasCharts.mjs --duration 30 --recover 15 [--interval 1000]
...
const def = { ...WEB_APPS.CanvasCharts };
